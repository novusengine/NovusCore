...
void AngelScriptSpellTemplate::GetData(std::string& /*key*/, void* /*ref*/, int /*typeId*/) const
{
...
void AngelScriptSpellTemplate::SetData(std::string& /*key*/, void* /*ref*/, int /*typeId*/) const
{
    /*u32 keyHash = StringUtils::fnv1a_32(key.c_str(), key.size());
    ScriptDataStorageComponent& dataStorageComponent = _registry->get<ScriptDataStorageComponent>(_entityId);
...
void AngelScriptSpell::GetData(std::string& /*key*/, void* /*ref*/, int /*typeId*/) const
{
    /*u32 keyHash = StringUtils::fnv1a_32(key.c_str(), key.size());
    ScriptDataStorageComponent& dataStorageComponent = _registry->get<ScriptDataStorageComponent>(_entityId);
...
void AngelScriptSpell::SetData(std::string& /*key*/, void* /*ref*/, int /*typeId*/) const
{
    /*u32 keyHash = StringUtils::fnv1a_32(key.c_str(), key.size());
    ScriptDataStorageComponent& dataStorageComponent = _registry->get<ScriptDataStorageComponent>(_entityId);
