        ...
        for (auto function : _hooks[id])
        {
            ...
            if (context)
            {
                ...
                for (auto argument : arguments)
                {
                    ...
                    {
                    case any::U8:
                        context->setByte(argument.get_u8());
                        break;
                    case any::U16:
                        context->setWord(argument.get_u16());
                        break;
                    case any::U32:
                        context->setDWord(argument.get_u32());
                        break;
                    case any::U64:
                        context->setQWord(argument.get_u64());
                        break;
                    case any::I8:
                        context->setByte(argument.get_i8());
                        break;
                    case any::I16:
                        context->setWord(argument.get_i16());
                        break;
                    case any::I32:
                        context->setDWord(argument.get_i32());
                        break;
                    case any::I64:
                        context->setQWord(argument.get_i64());
                        break;
                    case any::F32:
                        context->setFloat(argument.get_f32());
                        break;
                    case any::F64:
                        context->setDouble(argument.get_f64());
                        break;
                    case any::Bool:
                        context->setBool(argument.get_bool());
                        break;
                    case any::String:
                        context->setObject(&argument.get_string());
                        break;
                    case any::Player:
                        context->setObject(argument.get_player());
                        break;
                    }
                }
