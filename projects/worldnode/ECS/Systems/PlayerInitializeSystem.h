...
void Update(entt::registry& registry)
{
    ...
    view.each([&characterDatabase](const auto, PlayerInitializeComponent& playerInitializeData, PlayerFieldDataComponent& playerFieldData, UnitInfoComponent& playerInfo, PlayerVisualInfoComponent& playerVisualInfo, PlayerPositionComponent& playerPositionData, PlayerSpellStorageComponent& spellStorageData, PlayerSkillStorageComponent& skillStorageData, UnitStatsComponent& unitStatsComponent) {
        ...
        {
            playerPositionData.lastMovementOpcodeTime[i] = 0;
        }
        ...
        playerFieldData.SetFieldValue<i32>(UNIT_FIELD_POWER2, static_cast<i32>(unitStatsComponent.currentPower[POWER_RAGE] * 10));
        playerFieldData.SetFieldValue<i32>(UNIT_FIELD_POWER3, static_cast<i32>(unitStatsComponent.currentPower[POWER_FOCUS]));
        playerFieldData.SetFieldValue<i32>(UNIT_FIELD_POWER4, static_cast<i32>(unitStatsComponent.currentPower[POWER_ENERGY]));
        playerFieldData.SetFieldValue<i32>(UNIT_FIELD_POWER5, static_cast<i32>(unitStatsComponent.currentPower[POWER_HAPPINESS]));
        playerFieldData.SetFieldValue<i32>(UNIT_FIELD_POWER6, static_cast<i32>(unitStatsComponent.currentPower[POWER_RUNE]));
        playerFieldData.SetFieldValue<i32>(UNIT_FIELD_POWER7, static_cast<i32>(unitStatsComponent.currentPower[POWER_RUNIC_POWER]));
        playerFieldData.SetFieldValue<i32>(UNIT_FIELD_MAXHEALTH, static_cast<i32>(unitStatsComponent.maxHealth));
        playerFieldData.SetFieldValue<i32>(UNIT_FIELD_MAXPOWER1, static_cast<i32>(unitStatsComponent.maxPower[POWER_MANA]));
        playerFieldData.SetFieldValue<i32>(UNIT_FIELD_MAXPOWER2, static_cast<i32>(unitStatsComponent.maxPower[POWER_RAGE] * 10));
        playerFieldData.SetFieldValue<i32>(UNIT_FIELD_MAXPOWER3, static_cast<i32>(unitStatsComponent.maxPower[POWER_FOCUS]));
        playerFieldData.SetFieldValue<i32>(UNIT_FIELD_MAXPOWER4, static_cast<i32>(unitStatsComponent.maxPower[POWER_ENERGY]));
