...
#pragma pack(pop)
    ...
    enum Opcode
    {
        ...
        CMSG_GM_NUKE = 0x1FA, // not used in client
        ...
        CMSG_SERVER_BROADCAST = 0x2B2, // not used in client
        CMSG_SELF_RES = 0x2B3,
        SMSG_FEIGN_DEATH_RESISTED = 0x2B4,
        CMSG_RUN_SCRIPT = 0x2B5, // not used in client
        SMSG_SCRIPT_MESSAGE = 0x2B6, // not used in client
        ...
        CMSG_MOVE_START_SWIM_CHEAT = 0x2D8, // not used in client
        CMSG_MOVE_STOP_SWIM_CHEAT = 0x2D9, // not used in client
        ...
        CMSG_GM_UNTEACH = 0x2E5, // not used in client,
        ...
        MSG_DELAY_GHOST_TELEPORT = 0x32E, // not used in client
        ...
        MSG_GM_RESETINSTANCELIMIT = 0x33C, // not used in client
        SMSG_MOTD = 0x33D,
        ...
        CMSG_FORCE_SAY_CHEAT = 0x47E, // not used in client
        ...
        SMSG_ADD_RUNE_POWER = 0x488, // uint32 amounth
        ...
        CMSG_FLOOD_GRACE_CHEAT = 0x497, // not used in client
        ...
        CMSG_HEARTH_AND_RESURRECT = 0x49C, // lua: HearthAndResurrectFromArea empty
